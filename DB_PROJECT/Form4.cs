...
namespace DB_PROJECT
{
    public partial class Form4 : Form
    {
        ...
        {
            if (bookName.Text == "Enter Book Title")
            {
                bookName.Text = null;
        ...
        {
            if (bookarthor.Text == "Enter Arthor Name")
            {
        ...
        {
            if (publicationYear.Text == "Enter Publication Year")
            {
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            if (upload_profile_pic.ShowDialog() == DialogResult.OK)
            {
                ...
                MessageBox.Show("Book has been uploaded successfully");
                con.Close();


                DialogResult dialogResult = MessageBox.Show("Want To add more Books ?", "More books ?", MessageBoxButtons.YesNo);
        ...
        {
            if (bookPrice.Text == "Enter Book Price")
            {
                bookPrice.Text = null;
